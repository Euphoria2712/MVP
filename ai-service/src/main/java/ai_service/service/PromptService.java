...
public class PromptService {
    ...
    public String buildSystemPrompt(String userName, String ciudad,
        ...
        return """
            ...
            2. NO incluyas introducciones, explicaciones ni etiquetas markdown.
            3. Si no sabes algo, responde con el tipo "chat".
            4. El JSON debe comenzar con '{' y terminar con '}'.
        """.formatted(userName, ciudad, supermercadoFav, memorias, historial);
    }
